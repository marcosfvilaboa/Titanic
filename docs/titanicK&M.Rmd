...
Per a fer-ho, s'utilitzarà el Pearson’s Chi-squared del qual agafant el _valor de _p.value_ podrem saber si les variables tenen una correlació si és menor de 0.05.
