...
```
Per _Age_, a on els agrupem en les categoríes _Youth_, _Young Adult_, _Adult_ i _Senior_, segons si tenen de 0 a 14 anys, de 15 a 34, de 34 a 49 i de 50 a 70 respectivament.
```{r}
max(titanic$Age)
