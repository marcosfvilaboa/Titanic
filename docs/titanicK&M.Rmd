...
En canvi, 
```{r}
titanic <- titanic.original ## descartar vars que no volem (passID, Embarked, Ticket)
```


### -->>> Extreure TITOL de Name <<<-----  FET AL .R
...
#[Juntar SibSp i Parch i comprovar outliers un altre cop]
