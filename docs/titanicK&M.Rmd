...
Cal a dir, que després de provar més d'una combinació, aquesta és la més lògica amb un valor de r2 més elevat.
...
En l'anterior plot es pot veure fàcilment com les dones tenen més possibilitats de viure que els homes. També les diferències entre classes, tot i que entre la classe 2 i la 3 la diferència entre homes és menor com ja s'havia pogut observar en la regressió anteriorment.
...
Aquí es pot veure clarament com si que van sobreviure més joves però la diferència en la resta de grups d'edat no és gran.
...
On es pot observar una altra vegada que la nobles o els títol importants tenen més supervivència que els de classes més baixes. També que les dones amb títols de classe alta sobreviuen per sobre d'un 50%.
